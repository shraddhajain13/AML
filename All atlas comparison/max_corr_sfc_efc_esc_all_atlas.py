...
np.savetxt(r"C:\Users\shrad\OneDrive\Desktop\Juelich\Internship\Data\coup_sfc_efc_all_atlas_lc.csv", np.array(coup_sfc_efc_all_atlas).transpose(), delimiter = ',')
...
eff_size_p_val[:, 0] = np.array(eff_size_fc_coup)
eff_size_p_val[:, 1] = np.array(p_val)
np.savetxt(r"C:\Users\shrad\OneDrive\Desktop\Juelich\Internship\Data\eff_size_p_val_coup_lc_br.csv", eff_size_p_val, delimiter = ',')
"""