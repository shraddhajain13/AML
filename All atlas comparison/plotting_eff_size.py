...
p_val_arb = after_reg_brainsize[:, 1] * 11
...
p_val_arbc = after_reg_brainsize_empcorr[:, 1] * 11
...
ax2.set_title('P value (Bonferroni corrected) vs Atlas')
