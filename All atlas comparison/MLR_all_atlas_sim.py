...
male_data_br = pd.read_csv(r"D:\Shraddha\Data\male_data_sfc_efc_phase_br.csv", header = None).values #loading the ones before reg
female_data_br = pd.read_csv(r"D:\Shraddha\Data\female_data_sfc_efc_phase_br.csv", header = None).values #loading the ones before reg
...
plt.tight_layout()
plt.savefig(r"C:\Users\shrad\Desktop\phase_corr_sfc_efc_box_plot.png", dpi = 300)
plt.show()
"""
r"""
