...
for i in range(272):
    if(gender_list_filtered[i] == 'M'):
        ...
        #avg_male_list_sc.append(avg_corr_sfc_esc_list[i])
    if(gender_list_filtered[i] == 'F'):
        ...
        #avg_female_list_sc.append(avg_corr_sfc_esc_list[i])
    
#print(avg_female_list_sc)
#t, p = scipy.stats.ttest_ind(avg_male_list_sc, avg_female_list_sc)
#print("t value = ", t)
#print("p value = ", p)
